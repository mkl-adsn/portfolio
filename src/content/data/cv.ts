...
Clients I worked with included Ahlgrens Bilar, Helly Hansen, L'Oréal Paris, Malaco, and Pfizer, among others.`,
  },
  {
    ...
    description: `A temporary position held during the summer holidays. Work involved updating text and image content in brochures, adjusting layouts as needed, image retouching, and print design.`,
  },
  {
    company: 'Sydöstran Newspaper',
    period: '2010',
    role: 'Production Artist',
    description: `A temporary position held during the summer and winter holidays at the local morning newspaper Sydöstran. Responsibilities included laying out pages, fitting articles and images, creating news graphics, and occasionally rewriting articles to fit the available space.`,
  },
  {
    company: 'Freelance',
    period: '2009–2014',
    role: 'Graphic Designer',
    description: `Alongside my studies, I worked as a freelance graphic designer for various smaller clients. Projects ranged from websites and logotypes to print design.`,
  },
];
